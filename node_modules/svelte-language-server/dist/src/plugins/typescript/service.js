...
async function getService(path, workspaceUris, docContext) {
    var _a;
    const tsconfigPath = (0, utils_2.findTsConfigPath)(path, workspaceUris, docContext.tsSystem.fileExists);
    if (tsconfigPath) {
        return getServiceForTsconfig(tsconfigPath, (0, path_1.dirname)(tsconfigPath), docContext);
    }
    const nearestWorkspaceUri = workspaceUris.find((workspaceUri) => (0, utils_2.isSubPath)(workspaceUri, path));
