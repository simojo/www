...
function startServer(options) {
    ...
    connection.onInitialize((evt) => {
        ...
        const workspaceFolders = (_3 = evt.workspaceFolders) !== null && _3 !== void 0 ? _3 : [{ name: '', uri: (_4 = evt.rootUri) !== null && _4 !== void 0 ? _4 : '' }];
        pluginHost.register(new plugins_1.CSSPlugin(docManager, configManager, workspaceFolders, cssLanguageServices));
        pluginHost.register(new plugins_1.TypeScriptPlugin(configManager, new plugins_1.LSAndTSDocResolver(docManager, workspaceUris.map(utils_1.normalizeUri), configManager, {
            notifyExceedSizeLimit: notifyTsServiceExceedSizeLimit,
            onProjectReloaded: updateAllDiagnostics,
            watchTsConfig: true
        })));
        const clientSupportApplyEditCommand = !!((_5 = evt.capabilities.workspace) === null || _5 === void 0 ? void 0 : _5.applyEdit);
        const clientCodeActionCapabilities = (_6 = evt.capabilities.textDocument) === null || _6 === void 0 ? void 0 : _6.codeAction;
        const clientSupportedCodeActionKinds = (_7 = clientCodeActionCapabilities === null || clientCodeActionCapabilities === void 0 ? void 0 : clientCodeActionCapabilities.codeActionLiteralSupport) === null || _7 === void 0 ? void 0 : _7.codeActionKind.valueSet;
        return {
            capabilities: {
                textDocumentSync: {
                    openClose: true,
                ...
                codeActionProvider: (clientCodeActionCapabilities === null || clientCodeActionCapabilities === void 0 ? void 0 : clientCodeActionCapabilities.codeActionLiteralSupport)
                    ? {
                        codeActionKinds: [
                            ...
                            ((_8 = evt.initializationOptions) === null || _8 === void 0 ? void 0 : _8.shouldFilterCodeActionKind)
                ...
                executeCommandProvider: clientSupportApplyEditCommand
                    ...
                    : undefined,
                renameProvider: ((_10 = (_9 = evt.capabilities.textDocument) === null || _9 === void 0 ? void 0 : _9.rename) === null || _10 === void 0 ? void 0 : _10.prepareSupport)
