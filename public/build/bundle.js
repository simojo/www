...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h5 = element("h5");
    			t4 = text(/*date*/ ctx[3]);
    			add_location(h2, file, 26, 4, 574);
    			add_location(p, file, 27, 4, 595);
    			add_location(h5, file, 28, 4, 617);
    			attr_dev(a, "class", "postcard svelte-hsrppf");
    			add_location(a, file, 23, 2, 496);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*date*/ 8) set_data_dev(t4, /*date*/ ctx[3]);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(23:0) {#if title !== undefined}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*title*/ ctx[1] !== undefined && create_if_block$1(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { postid = undefined } = $$props;
    	let { title = undefined } = $$props;
    	let { subtitle = undefined } = $$props;
    	let { date = undefined } = $$props;
    	const writable_props = ['postid', 'title', 'subtitle', 'date'];
    	...
    	$$self.$capture_state = () => ({ push, postid, title, subtitle, date });
    	...
    	return [postid, title, subtitle, date, click_handler];
    }
    ...
    function create_each_block(ctx) {
    	...
    	postcard = new Postcard({
    			props: {
    				postid: /*postObj*/ ctx[5].postid,
    				title: /*postObj*/ ctx[5].title,
    				subtitle: /*postObj*/ ctx[5].subtitle,
    				date: /*postObj*/ ctx[5].date
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*postObjs*/ 1) postcard_changes.postid = /*postObj*/ ctx[5].postid;
    			if (dirty & /*postObjs*/ 1) postcard_changes.title = /*postObj*/ ctx[5].title;
    			if (dirty & /*postObjs*/ 1) postcard_changes.subtitle = /*postObj*/ ctx[5].subtitle;
    			if (dirty & /*postObjs*/ 1) postcard_changes.date = /*postObj*/ ctx[5].date;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:0) {#each postObjs as postObj}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 42, 0, 1152);
    			attr_dev(div, "class", "post-grid svelte-1hh6hsb");
    			add_location(div, file$1, 44, 0, 1163);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function parseIntoPostObj(s) {
    		let text = "";
    		await fetch(s.download_url).then(x => text = x.text()).catch(x => console.error(x));
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			add_location(h1, file$2, 6, 2, 107);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t);
    ...
    function create_fragment$3(ctx) {
    	let if_block_anchor;
    	let if_block = /*params*/ ctx[0].postId !== undefined && create_if_block$2(ctx);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			a3 = element("a");
    			a3.textContent = "Posts";
    			t7 = space();
    			a4 = element("a");
    			a4.textContent = "Posts";
    			t9 = space();
    			a5 = element("a");
    			a5.textContent = "Posts";
    			t11 = space();
    			a6 = element("a");
    			a6.textContent = "Posts";
    			t13 = space();
    			a7 = element("a");
    			a7.textContent = "Posts";
    			t15 = space();
    			a8 = element("a");
    			a8.textContent = "Posts";
    			t17 = space();
    			div1 = element("div");
    			create_component(router.$$.fragment);
    			attr_dev(a0, "class", "nav");
    			add_location(a0, file$3, 30, 2, 595);
    			attr_dev(a1, "class", "nav");
    			add_location(a1, file$3, 33, 2, 686);
    			attr_dev(a2, "class", "nav");
    			add_location(a2, file$3, 34, 2, 713);
    			attr_dev(a3, "class", "nav");
    			add_location(a3, file$3, 35, 2, 740);
    			attr_dev(a4, "class", "nav");
    			add_location(a4, file$3, 36, 2, 767);
    			attr_dev(a5, "class", "nav");
    			add_location(a5, file$3, 37, 2, 794);
    			attr_dev(a6, "class", "nav");
    			add_location(a6, file$3, 38, 2, 821);
    			attr_dev(a7, "class", "nav");
    			add_location(a7, file$3, 39, 2, 848);
    			attr_dev(a8, "class", "nav");
    			add_location(a8, file$3, 40, 2, 875);
    			attr_dev(div0, "id", "navbar");
    			add_location(div0, file$3, 29, 0, 575);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$3, 42, 0, 907);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
